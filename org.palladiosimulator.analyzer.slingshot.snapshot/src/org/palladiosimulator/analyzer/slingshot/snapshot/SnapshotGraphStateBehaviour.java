...
public class SnapshotGraphStateBehaviour implements SimulationBehaviorExtension {
	...
	public Result<DESEvent> onSimulationStarted(final SimulationStarted simulationStarted) {
		...
		final Set<DESEvent> eventsToInitOnNoIntervallPassed = this.removeIntervallPassed(this.eventsToInitOn);
	...
	/**
	 * Remove all {@link IntervalPassed} from the given set of events.
	 *
	 * @param events set of event to be cleansed.
	 */
	private Set<DESEvent> removeIntervallPassed(final Set<DESEvent> events) {
