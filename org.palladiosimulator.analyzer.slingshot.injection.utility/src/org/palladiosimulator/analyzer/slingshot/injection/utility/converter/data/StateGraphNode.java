...
import org.palladiosimulator.analyzer.slingshot.injection.utility.converter.data.MeasurementSet.Measurement;
import org.palladiosimulator.analyzer.slingshot.injection.utility.converter.data.Utility.UtilityType;
...
public record StateGraphNode(String id, double startTime, double endTime, List<MeasurementSet> measurements,
    ...
    /**
     * This calculates the utility of the state. In the form of "(slo1 - measure1) + (slo2 -
