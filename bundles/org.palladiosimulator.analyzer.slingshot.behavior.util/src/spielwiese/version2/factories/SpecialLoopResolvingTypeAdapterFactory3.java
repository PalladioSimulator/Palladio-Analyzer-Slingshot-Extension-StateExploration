...
public class SpecialLoopResolvingTypeAdapterFactory3 implements TypeAdapterFactory {
	 ...
	 * @param thingTypes
	 */
	public SpecialLoopResolvingTypeAdapterFactory3(final Map<String, Object> done, final Map<String, TypeAdapter<?>> thingTypes) {
	...
	private TypeAdapter<LoopThingParent> customizeMyClassAdapter(final Gson gson, final TypeToken<LoopThingParent> type) {
